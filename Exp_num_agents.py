...
from Classes.plotting.plotting import plot_carla_MARL_exp_num_agents_results
...
if test:
    ...
    for num_agents in range(0, params.num_agents):#params.num_agents, 2): # Max number of cooperative agents
        ...
        for mc in tqdm(range(MonteCarlo)):
            ...
            connectivity_matrix_A2A = make_symmetric(connectivity_matrix_A2A)
            ...
            test_results_MARL[num_agents][mc] = result_MARL
            # test_results_ICP[num_agents][mc] = result_ICP
...
if plot_test_results:
    plot_carla_MARL_exp_num_agents_results(test_results_MARL, dataset_class_instance, params, plt_show = 0, 
                                           plot_rmse_vs_num_max_agents=1, plot_num_agents_from_policy_vs_num_max_agents=0)
